...
classpath.push(files + "/datafixerupper-5.0.28.jar");
...
classpath.push(files + "/authlib-3.11.50.jar");
...
classpath.push(files + "/lwjgl-glfw-3.3.1.jar");
classpath.push(files + "/lwjgl-3.3.1.jar");
classpath.push(files + "/lwjgl-opengl-3.3.1.jar");
classpath.push(files + "/lwjgl-openal-3.3.1.jar");
classpath.push(files + "/icu4j-70.1.jar");
classpath.push(files + "/text2speech-1.12.4.jar");
classpath.push(files + "/lwjgl-stb-3.3.1.jar");
...
classpath.push(files + "/lwjgl-tinyfd-3.3.1.jar");
